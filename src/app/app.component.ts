import { enableProdMode, Component, ViewChildren, QueryList } from '@angular/core';
import { Router } from '@angular/router';
import { Platform, NavController, IonRouterOutlet, MenuController, ModalController, PopoverController, AlertController } from '@ionic/angular';
...
export class AppComponent {
  ...
  initializeApp() {
    this.platform.ready().then(() => {
      ...
      this.oneSignal.startInit('d069e88a-c2a3-486e-8898-654f649f7068', '675417539027');
