...
export class AppComponent {
  ...
  initializeTheme() {
    if (this.lightTheme) {
      ...
      this.root.style.setProperty('--backgroundMain', '#121212')
      this.root.style.setProperty('--backgroundContent', '#191919')
      this.root.style.setProperty('--activeBackground', '#3D3C3C')
      this.root.style.setProperty('--colorMain', '#fff')
      this.root.style.setProperty('--colorBlack', '#000')
      this.root.style.setProperty('--colorBlue', '#56CCF2')
      this.root.style.setProperty('--backgroundTransitionBtn', '#2c2c2c')
      this.root.style.setProperty('--colorCaption', '#E1E1E1')
      this.root.style.setProperty('--colorTabStatistic', '#c4c4c4')
      this.root.style.setProperty('--colorPlatform', '#a3a3a3')
      this.root.style.setProperty('--borderColor', '#202020')
      this.root.style.setProperty('--colorBtnLink', '#a3a3a3')
      this.root.style.setProperty('--backgroundButtonPush', '#fff')
      this.root.style.setProperty('--backgroundCalendar', '#e9e7e7')
      this.root.style.setProperty('--filter', 'invert(1)')
      this.root.style.setProperty('--backgroundGray', '#7A7A7A')
      this.root.style.setProperty('--backgroundChat', '#2d2d2d')
      this.root.style.setProperty('--backgroundPreviewBtn', '#191919')
      this.root.style.setProperty('--filterInvert', 'invert(0)')
      this.root.style.setProperty(
        '--grayGradient',
        'linear-gradient(91.14deg, rgba(255, 255, 255, 0.53) -13.28%, rgba(0, 0, 0, 0.2597) 138.38%)'
      )
      this.root.style.setProperty('--colorSelect', '#bfbfbf')
      this.root.style.setProperty('--colorCaptionPreview', '#ABABAB')
      this.root.style.setProperty('--colorPreviewBtn', '#56CCF2')
    }
  }
