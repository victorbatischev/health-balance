          ...
          .subscribe(
            (data: any) => {
              for (let i = 0; i < data.result.platforms.length; i++) {
                this.listData.push({
                  id: data.result.platforms[i].id,
                  img: data.result.platforms[i].image,
                  title: data.result.platforms[i].title,
                  src: 'program-name/' + data.result.platforms[i].id,
                  subLink: 'Смотреть программы',
                  subTitle: ''
                })
                ...
                //     img: data.result.platforms[i].image,
                //     title: data.result.platforms[i].title,
                //     src: 'create-program/' + data.result.platforms[i].id,
                //     subLink: 'Добавить программу',
                //     subTitle: ''
                //   })
                // } else {
                //   this.listData.push({
