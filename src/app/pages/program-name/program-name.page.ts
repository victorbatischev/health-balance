            ...
            (data: any) => {
              ...
              for (let i = 0; i < this.programs.length; i++) {
                this.listData.push({
                  ...
                  main_img:
                    this.platform_id == '0' ? this.programs[i].main_image : '',
                  title: this.programs[i].title,
                  subTitle: this.programs[i].title,
                  src:
                    'nutrition/' + this.platform_id + '/' + this.programs[i].id,
                  subLink: 'Посмотреть',
  ...
  doSearch() {
    ...
    for (let i = 0; i < this.programs.length; i++) {
      if (
        ...
        this.strpos(
          this.programs[i].title.toLowerCase(),
        ...
        this.listData.push({
          ...
          title: this.programs[i].title,
          subTitle: this.programs[i].title,
          src: 'nutrition/' + this.platform_id + '/' + this.programs[i].id,
          subLink: 'Посмотреть'
        })
      }
    }
